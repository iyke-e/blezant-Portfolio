    ...
    <div id="contact" className="scroll-mt-14 md:scroll-mt-12 section-inline my-20 ">
      ...
      <div className="grid md:flex items-center gap-8 md:gap-20">
        <div className="w-full space-y-4">
          ...
          <p>
            I'm always excited to hear about new mobile projects, big or small.
            Whether you have a specific idea in mind or need help exploring the
            possibilities, let's connect. I'm available for full-project
        ...
        <form className="w-full rounded-xl grid gap-10 p-6 border border-white/20">
          <div className="grid gap-2">
            ...
            <input
              className="border-b outline-0 border-white/20 pb-2"
          ...
          <div className="grid gap-2">
            ...
            <textarea
              className="border rounded-xl border-white/20 outline-0  h-20 w-full pb-2"
              name="message"
              id=""
            ></textarea>
          </div>
